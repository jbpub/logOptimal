<?php
/*
 * Generates the site selection page.
*/
...
$page_title='Select Site';
$page_heading='Select site';
include 'header.inc';
		    ...
		    <span class="clearboth" ></span>
                    <form action="" method="post" name="loginForm" style="margin:0;">
                        <table border="0" width="250" id="loginTable">
                            ...
                            <tr>
<?php echo '
                            <td colspan="2" align="right" ><img src="./'.URI_IMAGES.'forgotpassword.jpg" /><input name="submit" value="1" type="image" src="./'.URI_IMAGES.'loginbtn.jpg"  /></td>
<!--
