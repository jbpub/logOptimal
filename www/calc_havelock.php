...
//var_dump($_REQUEST);
$ndays = $_REQUEST['ndays'] or '';
echo '<form action="'.$_SERVER['PHP_SELF'] .'" method="get" name="loginForm" style="margin:0;">';
echo '<label for="ndays">Number of days:</label>';
echo '<input type="text" name="ndays" id="ndays" value="'.$ndays.'" tabindex="1" size="4" maxlength="4" accesskey="u" autocomplete="on" autofocus />';
echo '<input name="submit" value="Recalculate" type="submit" tabindex="-1" />'."\n";
echo "</form>\n";
